...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nama_game && $deskripsi_game) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update game set nama = '$nama_game', deskripsi = '$deskripsi_game' where id = '$id'";
            $q1         = mysqli_query($conn, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into game(nama,deskripsi) values ('$nama_game','$deskripsi_game')";
            $q1     = mysqli_query($conn, $sql1);
            if ($q1) {
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Deskripsi Game</th>
